...
There are two types of payment packets: quoted and forwarded. A quoted payment specifies the amount that should arrive at the destination, a forwarded
payment doesn't.

Here is a summary of the fields in the quoted and forwarded ILP payment packet formats:

#### Quoted Payment Packet
